        ...
        ? function (t, e, n) {
            ...
            return (
              ...
              'function' == typeof t &&
                ...
                r[h] &&
                ((t[e] = n.value),
                (n = { configurable: (p in n ? n : r)[p], enumerable: (d in n ? n : r)[d], writable: !1 })),
              l(t, e, n)
            );
          }
        : l
              ...
              value: function (e) {
                ...
                Rc.forEach(function (t) {
                  ...
                  this._element.style.minWidth ||
                    (S.style(this._element, { 'min-width': ''.concat(this._element.offsetWidth, 'px') }),
        ...
        for (
          ...
          if (1 === p) {
            ...
            for (var m = 7 - h.length, g = 0; g < m; g++) {
              var b = Qc(c, o, f);
              h.push({ date: b, currentMonth: d, isSelected: e && Jc(b, e), isToday: Jc(b, Xc()), dayNumber: O(b) }),
                f++;
            }
          } else
            for (var _ = 1; _ < 8; _++) {
              u < f && (d = !(f = 1));
              var w = Qc(c, d ? o : a, f);
              h.push({ date: w, currentMonth: d, isSelected: e && Jc(w, e), isToday: Jc(w, Xc()), dayNumber: O(w) }),
                f++;
            }
          r.push(h);
        }
