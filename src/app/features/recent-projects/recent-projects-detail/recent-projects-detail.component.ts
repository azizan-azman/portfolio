          ...
          imageList: [
            {
              imagePathList: [
                ...
                {
                  imagePath: 'output/images/recent-projects/project-001/tcs/project-001-introduction-tcs-create-sm.png',
            ...
            },
            {
              imagePathList: [
                ...
                {
                  imagePath: 'output/images/recent-projects/project-001/tcss/project-001-introduction-tcss-list-sm.png',
                ...
                {
                  imagePath: 'output/images/recent-projects/project-001/tcss/project-001-introduction-tcss-edit-sm.png',
        ...
        },
        {
          imageList: [
            ...
            },
            {
              imagePathList: [
                {
                  imagePath: 'output/images/recent-projects/project-001/strategy/project-001-strategy-lazy-loading.png',
          ...
          imageList: [
            {
              imagePathList: [
                {
                  imagePath: 'output/images/recent-projects/project-001/role/project-001-role-balsamic-wireframe-2.png',
          ...
          imageList: [
            {
              imagePathList: [
                {
                  imagePath: 'output/images/recent-projects/project-003/introduction/project-003-introduction-home.png',
